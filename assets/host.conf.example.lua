...
config = {
    -- Starting cell size in px (clamped 8..72). Ctrl+- / Ctrl++ step it
    -- by 2 at runtime, Ctrl+0 returns here.
    font_size = 24.0,
    ...
    -- Scrolled-off rows kept for the wheel / scrollbar to reach.
    scrollback_rows = 1000,

    -- File-type icon set behind the `file/*` names: "oxygen" (default) /
    -- "material" / "papirus".
    icon_theme = "oxygen",
}
